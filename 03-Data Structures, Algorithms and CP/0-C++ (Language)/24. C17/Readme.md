...
- [structured bindings or Decomposition Declaration](#structured-bindings-or-Decomposition-Declaration)
- [selection statements with initializer or Init statement for if/switch](#selection-statements-with-initializer-or-Init-statement-for-if/switch)
...
## Selection statements with initializer or Init statement for if/switch

New versions of the `if` and `switch` statements which simplify common code patterns and help users keep scopes tight.

This can also be used with structured bindings.
