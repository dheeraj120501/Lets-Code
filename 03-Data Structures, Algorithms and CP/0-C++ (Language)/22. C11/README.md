...
- [InClass Initializer and Delegation of Constuctors](#InClass-Initializer-and-Delegation-of-Constuctors)
- [Ellipsis](#Ellipsis)
...
Used to take variable number of arguments in the function.
...
It is used to define functions with no name.
...
If you need a variable,say z, to have same data type as some other variable, say y for that we can do `decltype(y) z = 15*10.5`
